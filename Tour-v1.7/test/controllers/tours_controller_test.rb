...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { cost: @tour.cost, description: @tour.description, location: @tour.location, title: @tour.title }
    end
  ...
  test "should update tour" do
    patch :update, id: @tour, tour: { cost: @tour.cost, description: @tour.description, location: @tour.location, title: @tour.title }
    assert_redirected_to tour_path(assigns(:tour))
  end
